...
<!doctype html>
<title>Today - Hatfield Times</title>
<style>
...
<header class="topper">
  ...
  <div class="center" style="top: 10px">
    ...
    <br>
    <h3 style="color:#ae0000;"><b>TODAY<b></h3>
    <style>
      h2 {
           font-family: Canterbury;
           font-size: 100px;
        ...
        <button class="dropbtn">FILTERS</button>
          <div class="center2">
            <div class="dropdown-content">
              <a href="#" onclick="pol()">POLITICS</a>
              <a href="#" onclick="ent()">ENTERTAINMENT</a>
...
<body>
  ...
  <a href="../php/login.php" class="strokeme">LOGIN<i class="fa-solid fa-user"></i></a>
  <br>
  <a href="../html/calendar.php" class="strokeme">CALENDAR<i class="fa-solid fa-calendar"></i></a>
  <br>
  <a href="../html/world.php" class="strokeme">CLICK FOR WORLD NEWS<i class="fa-solid fa-earth-africa"></i></a>

  <body onload="hideLoadingDiv()">
      <div class="LOADING" id="LOADING" name="LOADING"><img src="../img/tload.svg" style="width:100px;height:100px;"></div>
  </body>
